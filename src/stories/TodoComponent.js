...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["TaskScheduler.Domain.Panel"] = $PS["TaskScheduler.Domain.Panel"] || {};
  var exports = $PS["TaskScheduler.Domain.Panel"];         
  var ActivityInventoryList = (function () {
      function ActivityInventoryList() {

      };
      ActivityInventoryList.value = new ActivityInventoryList();
      return ActivityInventoryList;
  })();
  exports["ActivityInventoryList"] = ActivityInventoryList;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["TaskScheduler.Domain.Task"] = $PS["TaskScheduler.Domain.Task"] || {};
  var exports = $PS["TaskScheduler.Domain.Task"];
  var Tag = (function () {
      function Tag(value0) {
          this.value0 = value0;
      };
  ...
  var showPriority = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at TaskScheduler.Domain.Task (line 19, column 1 - line 22, column 21): " + [ v.constructor.name ]);
      }
  };
  exports["High"] = High;
  ...
  exports["Low"] = Low;
  exports["Tag"] = Tag;
  exports["showPriority"] = showPriority;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["App.Component.AddTodoDialog"] = $PS["App.Component.AddTodoDialog"] || {};
  var exports = $PS["App.Component.AddTodoDialog"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var TaskScheduler_Domain_Panel = $PS["TaskScheduler.Domain.Panel"];
  var TaskScheduler_Domain_Task = $PS["TaskScheduler.Domain.Task"];                
  ...
  var TaskCreated = (function () {
      function TaskCreated(value0) {
          this.value0 = value0;
      };
      TaskCreated.create = function (value0) {
          return new TaskCreated(value0);
      };
      return TaskCreated;
  })();
  var TaskTitleAdded = (function () {
      function TaskTitleAdded(value0) {
          this.value0 = value0;
      };
      TaskTitleAdded.create = function (value0) {
          return new TaskTitleAdded(value0);
      };
      return TaskTitleAdded;
  })();
  var PrioritySelected = (function () {
      function PrioritySelected(value0) {
          this.value0 = value0;
      };
      PrioritySelected.create = function (value0) {
          return new PrioritySelected(value0);
      };
      return PrioritySelected;
  })();
  var TagsEntered = (function () {
      function TagsEntered(value0) {
          this.value0 = value0;
      };
      TagsEntered.create = function (value0) {
          return new TagsEntered(value0);
      };
      return TagsEntered;
  })();
  var CancelClicked = (function () {
      ...
      CancelClicked.value = new CancelClicked();
  ...
  var SaveClicked = (function () {
      ...
      SaveClicked.value = new SaveClicked();
      return SaveClicked;
  })();
  var priorityFromString = function (s) {
      var v = Data_String_Common.toLower(s);
      if (v === "low") {
          return new Data_Maybe.Just(TaskScheduler_Domain_Task.Low.value);
      };
      if (v === "medium") {
          return new Data_Maybe.Just(TaskScheduler_Domain_Task.Medium.value);
      };
      if (v === "high") {
          return new Data_Maybe.Just(TaskScheduler_Domain_Task.High.value);
      };
      return Data_Maybe.Nothing.value;
  };
  var defaultPriority = TaskScheduler_Domain_Task.Low.value;
  var component = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "modal", "is-active" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("modal-background") ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("modal-card") ])([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.class_("modal-card-head") ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("modal-card") ])([ Halogen_HTML_Core.text("Create A Task") ]) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_("modal-card-body") ])([ Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("label") ])([ Halogen_HTML_Core.text("Title") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("control") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(""), Halogen_HTML_Properties.class_("input"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.placeholder("Enter task title"), Halogen_HTML_Events.onValueInput(TaskTitleAdded.create) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("label") ])([ Halogen_HTML_Core.text("Priority") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("control") ])([ Halogen_HTML_Elements.select([ Halogen_HTML_Events.onValueChange(function (s) {
              return PrioritySelected.create(Data_Maybe.fromJust()(priorityFromString(s)));
          }) ])((function () {
              var mkOption = function (p) {
                  return Halogen_HTML_Elements.option([ Halogen_HTML_Properties.value(Data_String_Common.toLower(Data_Show.show(TaskScheduler_Domain_Task.showPriority)(p))) ])([ Halogen_HTML_Core.text(Data_Show.show(TaskScheduler_Domain_Task.showPriority)(p)) ]);
              };
              return [ mkOption(TaskScheduler_Domain_Task.Low.value), mkOption(TaskScheduler_Domain_Task.Medium.value), mkOption(TaskScheduler_Domain_Task.High.value) ];
          })()) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("label") ])([ Halogen_HTML_Core.text("Tags") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("control") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(""), Halogen_HTML_Properties.class_("input"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.placeholder("Enter tags as comma-separated values"), Halogen_HTML_Events.onValueInput(TagsEntered.create) ]) ]) ]) ]) ]), Halogen_HTML_Elements.footer([ Halogen_HTML_Properties.class_("modal-card-foot") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ "button", "is-failure" ]), Halogen_HTML_Events.onClick(function (v1) {
              return CancelClicked.value;
          }) ])([ Halogen_HTML_Core.text("Cancel") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ "button", "is-success" ]), Halogen_HTML_Events.onClick(function (v1) {
              return SaveClicked.value;
          }) ])([ Halogen_HTML_Core.text("Save Task") ]) ]) ]) ]);
      };
      ...
      var handleAction = function (v) {
          if (v instanceof TaskTitleAdded) {
          ...
          if (v instanceof PrioritySelected) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $17 = {};
                  for (var $18 in st) {
                  ...
                  $17.priority = v.value0;
                  return $17;
              });
          };
          if (v instanceof TagsEntered) {
              var tags = Data_Functor.map(Data_Functor.functorArray)(function ($26) {
                  return TaskScheduler_Domain_Task.Tag.create(Data_String_Common.trim($26));
              })(Data_String_Common.split(",")(v.value0));
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $21 = {};
                  for (var $22 in st) {
          ...
          if (v instanceof CancelClicked) {
              return Halogen_Query_HalogenM.raise(Canceled.value);
          };
          if (v instanceof SaveClicked) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (taskData) {
                  var $25 = !Data_String_Common["null"](taskData.title);
                  if ($25) {
                      return Halogen_Query_HalogenM.raise(new TaskCreated({
                          title: taskData.title,
                          priority: taskData.priority,
                          tags: taskData.tags,
                          associatedPanel: TaskScheduler_Domain_Panel.ActivityInventoryList.value
                      }));
                  };
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              });
          };
          throw new Error("Failed pattern match at App.Component.AddTodoDialog (line 122, column 18 - line 137, column 23): " + [ v.constructor.name ]);
      };
...
})(PS["Halogen.CustomElement"] = PS["Halogen.CustomElement"] || {});
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
...
(function($PS) {
  ...
  "use strict";
  $PS["Halogen.CustomElement"] = $PS["Halogen.CustomElement"] || {};
  var exports = $PS["Halogen.CustomElement"];
  var $foreign = $PS["Halogen.CustomElement"];
  var Data_Unit = $PS["Data.Unit"];
  ...
  var define = function (name) {
      return function (component) {
          var render = function (el) {
              return Halogen_Aff_Util.runHalogenAff(Halogen_VDom_Driver.runUI(component)(Data_Unit.unit)(el));
          };
          return $foreign.define_(name)(render);
      };
  };
...
(function($PS) {
  ...
  $PS["Main"] = $PS["Main"] || {};
  var exports = $PS["Main"];
  var App_Component_AddTodoDialog = $PS["App.Component.AddTodoDialog"];
  var Halogen_CustomElement = $PS["Halogen.CustomElement"];                
  var main = Halogen_CustomElement.define("halogen-todo")(App_Component_AddTodoDialog.component);
  exports["main"] = main;
})(PS);
PS["Main"].main();